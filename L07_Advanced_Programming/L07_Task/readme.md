Heutige Aufgabe ist es einen Messenger grob nach zu bilden, dabei hat der Messenger folgende zugrundeliegende Struktur:
...
6. Bei einem Bild oder einer Datei sind folgende Dinge bekannt:
  1. Größe der Datei oder des Bildes 
  2. Name der Datei oder des Bildes.
    1. Falls es sich um eine Direktaufnahme bei einem Bild handelt, soll der Name des Bildes automatisch generiert werden.
    2. Falls das Bild nicht optimal aufgenommen wurde, soll es die Möglichkeit geben, das Bild nochmals zu schießen.
...
2. Zeichnet ein Klassendiagramm für die Charakteristiken des obigen Beispiels.
  1. Denkt euch mögliche Attribute und Funktionen für die Klassen aus, welche ihr für sinnvoll erachtet.
